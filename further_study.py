...
def custom_append(input_list, value):
    ...
    input_list[list_length-1:] = [input_list[list_length-1], value]
...
def custom_insert(input_list, index, value):
    ...
    last_half = input_list[(index):]

    custom_append(first_half, value)
    custom_extend(first_half, last_half)
    input_list = first_half
